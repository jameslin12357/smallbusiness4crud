        ...
        <div class="row">
            <div class="col-md-3">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row" class="active-tab"><a href="/rooms">Rooms</a></th>
                        <!--<td>Larry</td>-->
                        <!--<td>the Bird</td>-->
                        <!--<td>@twitter</td>-->
                    </tr>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        @if (Auth::user()->level === 1)
                            <th scope="col"><a href="/rooms/create" class="btn btn-outline-secondary">Create</a></th>
                        @endif
                    ...
                    @foreach ($rooms as $room)
                        <tr>
                            ...
                            <td>{{ $room->date_edited }}</td>
                            @if (Auth::user()->level === 1)
                                <td>
                                    <a href="/rooms/{{ $room->id }}/edit" class="btn btn-outline-secondary">Edit</a>
                                </td>
                                <td>
