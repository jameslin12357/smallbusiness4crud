        ...
        <div class="row">
            <div class="col-md-3">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row" class="active-tab"><a href="/courses">Courses</a></th>
                        <!--<td>Jacob</td>-->
                        <!--<td>Thornton</td>-->
                        <!--<td>@fat</td>-->
                    </tr>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        @if (Auth::user()->level === 1)
                            <th scope="col"><a href="/courses/create" class="btn btn-outline-secondary">Create</a></th>
                        @endif
                    ...
                    @foreach ($courses as $course)
                        <tr>
                            ...
                            <td>{{ $course->date_edited }}</td>
                            @if (Auth::user()->level === 1)
                                <td>
                                    <a href="/courses/{{ $course->id }}/edit" class="btn btn-outline-secondary">Edit</a>
                                </td>
                                <td>
